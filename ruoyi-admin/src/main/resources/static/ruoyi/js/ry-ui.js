    ...
    $.extend({
        ...
        table: {
            ...
            tooltip: function (value, length, target) {
                var _length = $.common.isEmpty(length) ? 50 : length;
                var _text = "";
                ...
                if (_value.length > _length) {
                    ...
                    _value = _value.replace(/\"/g,"&quot;");
                    var actions = [];
                    actions.push($.common.sprintf('<input class="tooltip-show" style="width:200px;opacity: 0;position: absolute; z-index:-1" type="text" value="%s"/>', _value));
        ...
        operate: {
            ...
            addSize: function (width, height, id) {
            ...
            editSize: function (width, height, id) {
                if ($.common.isEmpty(id) && table.options.type == table_type.bootstrapTreeTable) {
                    var row = $('#' + table.options.id).bootstrapTreeTable('getSelections')[0];
                    if ($.common.isEmpty(row)) {
                        $.modal.alertWarning("请至少选择一条记录");
